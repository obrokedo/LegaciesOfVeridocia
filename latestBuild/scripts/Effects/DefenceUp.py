...
class DefenceUp(BattleEffect):
    ...
    def effectStarted(self, attacker, target):    
        ...
        if effectLevel == 1:
            target.setCurrentDefense(int(target.getCurrentDefense() * 1.25))
        elif effectLevel == 2:
            target.setCurrentDefense(int(target.getCurrentDefense() * 1.30))
        elif effectLevel == 3:
            target.setCurrentDefense(int(target.getCurrentDefense() * 1.35))
        elif effectLevel == 4:
            target.setCurrentDefense(int(target.getCurrentDefense() * 1.40))
        return None;

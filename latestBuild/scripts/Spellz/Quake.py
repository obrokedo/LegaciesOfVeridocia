...
class Quake(SpellDefinition):    
    # This is where you set up all of the parameters for each of the spells    
    def __init__(self):
        self.setName("Quake")       
        self.setCosts(jarray.array([12, 17, 27, 27], 'i'))
        self.setDamage(jarray.array([-18, -26, -32, -34], 'i'))
    ...
    def getBattleText(self, target, damage, mpDamage, attackerHPDamage, attackerMPDamage):
        return "Ground starts to quake " + target.getName() + ", dealing " + `damage * -1` + " damage! "

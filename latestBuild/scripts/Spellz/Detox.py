...
class Detox(SpellDefinition):    
    ...
    def __init__(self):
        ...
        self.setEffects(jarray.array(["Detox"], String), 1) # Level 1 battle effects
        self.setEffects(jarray.array(["Detox"], String), 2) # Level 2 battle effects
        self.setEffects(jarray.array(["Detox"], String), 3) # Level 3 battle effects
        self.setEffects(jarray.array(["Detox"], String), 4) # Level 4 battle effects

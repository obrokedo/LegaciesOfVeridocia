...
class Gust(SpellDefinition):    
    # This is where you set up all of the parameters for each of the spells    
    def __init__(self):
        self.setName("Gust")       
        self.setCosts(jarray.array([3, 7, 16, 16], 'i'))
        self.setDamage(jarray.array([-6, -12, -18, -24], 'i'))
        self.setRange(jarray.array([Range.ONE_ONLY, Range.TWO_AND_LESS, Range.THREE_AND_LESS, Range.THREE_AND_LESS], Range))
        ...
        self.setEffects(jarray.array(["Encumbered"], String), 1) # Level 1 battle effects
        self.setEffects(jarray.array(["Encumbered"], String), 2) # Level 2 battle effects
        self.setEffects(jarray.array(["Encumbered"], String), 3) # Level 3 battle effects
        self.setEffects(jarray.array(["Encumbered"], String), 4) # Level 4 battle effects
    ...
    def getBattleText(self, target, damage, mpDamage, attackerHPDamage, attackerMPDamage):
        return "Gust starts to blow " + target.getName() + ", dealing " + `damage * -1` + " damage! "

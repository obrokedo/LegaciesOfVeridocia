...
class Boulder(SpellDefinition):    
    # This is where you set up all of the parameters for each of the spells    
    def __init__(self):
        self.setName("Boulder")       
        self.setCosts(jarray.array([3, 5, 13, 13], 'i'))
        self.setDamage(jarray.array([-12, -18, -25, -40], 'i'))
        self.setRange(jarray.array([Range.ONE_ONLY, Range.ONE_ONLY, Range.ONE_ONLY, Range.TWO_AND_LESS], Range))
        ...
        self.setEffects(jarray.array(["Petrification"], String), 1) # Level 1 battle effects
        self.setEffects(jarray.array(["Petrification"], String), 2) # Level 2 battle effects
        self.setEffects(jarray.array(["Petrification"], String), 3) # Level 3 battle effects
        self.setEffects(jarray.array(["Petrification"], String), 4) # Level 4 battle effects

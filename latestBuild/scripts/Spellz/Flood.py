...
class Flood(SpellDefinition):    
    # This is where you set up all of the parameters for each of the spells    
    def __init__(self):
        self.setName("Flood")       
        self.setCosts(jarray.array([8, 15, 20, 20], 'i'))
        self.setDamage(jarray.array([-14, -17, -23, -30], 'i'))
    ...
    def getBattleText(self, target, damage, mpDamage, attackerHPDamage, attackerMPDamage):
        return "A flood of water fly's at " + target.getName() + ", dealing " + `damage * -1` + " damage! "

...
class Torrent(SpellDefinition):    
    # This is where you set up all of the parameters for each of the spells    
    def __init__(self):
        self.setName("Torrent")       
        self.setCosts(jarray.array([2, 5, 10, 10], 'i'))
        self.setDamage(jarray.array([-6, -10, -18, -36], 'i'))
        ...
        self.setEffects(jarray.array(["Sleep"], String), 1) # Level 1 battle effects
        self.setEffects(jarray.array(["Sleep"], String), 2) # Level 2 battle effects
        self.setEffects(jarray.array(["Sleep"], String), 3) # Level 3 battle effects
        self.setEffects(jarray.array(["Sleep"], String), 4) # Level 4 battle effects
    ...
    def getBattleText(self, target, damage, mpDamage, attackerHPDamage, attackerMPDamage):
        return "A torrent of water fly's at " + target.getName() + ", dealing " + `damage * -1` + " damage! "

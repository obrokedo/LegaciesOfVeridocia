...
class Plague(SpellDefinition):    
    # This is where you set up all of the parameters for each of the spells    
    def __init__(self):
        self.setName("Plague")       
        self.setCosts(jarray.array([20, 30], 'i'))
        self.setDamage(jarray.array([0, 0], 'i'))
        self.setRange(jarray.array([Range.TWO_AND_LESS, Range.TWO_AND_LESS], Range))
        self.setArea(jarray.array([2, 3], 'i'))            
        ...
        self.setEffects(jarray.array(["InstantDeath"], String), 1) # Level 1 battle effects
        self.setEffects(jarray.array(["InstantDeath"], String), 2) # Level 2 battle effects
    ...
    def getBattleText(self, target, damage, mpDamage, attackerHPDamage, attackerMPDamage):
        return "Ominous presense fly at " + target.getName()

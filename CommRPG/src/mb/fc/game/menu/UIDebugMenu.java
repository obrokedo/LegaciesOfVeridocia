...
public class UIDebugMenu
{
	...
	public void update(GameContainer container, StateBasedGame game, int delta) throws SlickException {
		int mouseX = (container.getInput().getMouseX() - CommRPG.GAME_SCREEN_PADDING) / CommRPG.GAME_SCREEN_SCALE;
		int mouseY = container.getInput().getMouseY() / CommRPG.GAME_SCREEN_SCALE;
	...
	public void render(Graphics g) {
		...
		g.fillRect(0, 0, 100, CommRPG.GAME_SCREEN_SIZE.height);

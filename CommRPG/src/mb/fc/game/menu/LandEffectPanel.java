...
public class LandEffectPanel extends Panel
{
	...
	public void render(FCGameContainer gc, Graphics graphics) {
		Panel.drawPanelBox(gc.getDisplayPaddingX() + 15, gc.getHeight() - 65, 240, 50, graphics);
		graphics.setColor(Panel.COLOR_FOREFRONT);
		graphics.drawString("Land Effect: " + landEffect + "%", gc.getDisplayPaddingX() + 30, gc.getHeight() - 70);
	}

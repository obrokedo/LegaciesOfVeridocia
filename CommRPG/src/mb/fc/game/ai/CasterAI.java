...
public abstract class CasterAI extends AI 
{
	...
	protected AttackSpriteAction getPerformedTurnAction(CombatSprite target) {
		if (bestSpell == null)
		{
			...
			return new AttackSpriteAction(TurnAction.ACTION_ATTACK_SPRITE, target, 
		...
		else
		{
			...
			if (targets != null)
				return new AttackSpriteAction(TurnAction.ACTION_ATTACK_SPRITE, targets, new BattleCommand(BattleCommand.COMMAND_SPELL, bestSpell, spellLevel));
			else
				return new AttackSpriteAction(TurnAction.ACTION_ATTACK_SPRITE, target, new BattleCommand(BattleCommand.COMMAND_SPELL, bestSpell, spellLevel));
		}
	}

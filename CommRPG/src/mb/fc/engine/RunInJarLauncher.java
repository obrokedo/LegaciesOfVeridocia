...
public class RunInJarLauncher
{
  public RunInJarLauncher()
    throws Exception
  {
  ...
  public File getCodeSourceLocation()
  {
    try
    {
      return new File(RunInJarLauncher.class.getProtectionDomain().getCodeSource().getLocation().toURI());
